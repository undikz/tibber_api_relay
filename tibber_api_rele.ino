...
//Konstanter
const int relay = 5;
const char* ssid =  "PLHWiFi"; //Bytt til din WiFi SSID
const char* pass =  "887adtnu";//Bytt til ditt WiFi-passord
...
//  Serial.println(timeBuffer);
  ...
  if ((firstRun || (currentSeconds >= dailyActivationTime && currentSeconds < dailyActivationTime + 60) || thresholdChanged) && millis() - lastActivationCheck > 60000) {
    ...
    http.addHeader("Authorization", "Bearer 8FV4wPdSbmW2ilT_STEJNMmuKnjK4AjHKMAnWeGjQCw"); //Bytt til din API-nøkkel
